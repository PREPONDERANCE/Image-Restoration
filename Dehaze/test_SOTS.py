...
parser.add_argument(
    "--weights", default="./models/Dehazing.jth", type=str, help="Path to weights"
)
parser.add_argument("--dataset", default="SOTS", type=str, help="Test Dataset")
...
for dataset in datasets:
    ...
    inp_dir = os.path.join(opt["datasets"]["val"]["folder"], dataset, "hazy/")
    files = natsorted(
