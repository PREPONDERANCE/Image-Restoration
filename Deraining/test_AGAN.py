...
parser.add_argument(
    "--input_dir",
    default="/mnt/sda/zsh/dataset/",
    type=str,
    help="Directory of validation images",
)
parser.add_argument(
    "--result_dir", default="./results/FPro_AGAN/", type=str, help="Directory for results"
)
parser.add_argument(
    "--weights", default="./models/deraindrop_FPro.pth", type=str, help="Path to weights"
)
parser.add_argument(
    "--opt",
    type=str,
    default="Options/RealDeraindrop_FPro.yml",
