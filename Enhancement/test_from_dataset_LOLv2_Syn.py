...
parser.add_argument(
    "--opt",
    type=str,
    default="./Enhancement/Options/HINT_LOL_v2_synthetic.yml",
    help="Path to option YAML file.",
)
parser.add_argument(
    "--weights",
    default="/home/ubuntu/gwt/code/Hint/experiments/Enhancement_HINT/models/net_g_latest.jth",
    type=str,
