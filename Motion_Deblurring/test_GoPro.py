...
parser.add_argument(
    "--input_dir",
    default="/home/ubuntu13/zsh/dataset/Uformer/deblurring/",
    type=str,
...
parser.add_argument(
    "--weights", default="./models/deblur.pth", type=str, help="Path to weights"
)
parser.add_argument(
...
parser.add_argument(
    "--opt",
    type=str,
    default="./Motion_Deblurring/Options/Deblurring_FPro.yml",
...
with jt.no_grad():
    for file_ in tqdm(files):
        ...
        restored = (
            jt.clamp(restored, 0, 1).cpu().detach().permute(0, 2, 3, 1).squeeze(0).numpy()
        )
